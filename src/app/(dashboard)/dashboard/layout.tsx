  ...
  return (
    <div className="w-full flex h-screen">
      ...
      <div className="hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
        <Link
          href="/dashboard"
          className="flex h-16 shrink-0 items-center mt-10"
        >
          <Image src={"/fav.png"} alt="logo" width={70} height={70} />
        </Link>
      ...
      <aside className="max-h-screen custom-container py-16 md:py-12 w-full">
        {children}
      </aside>
    </div>
  );
